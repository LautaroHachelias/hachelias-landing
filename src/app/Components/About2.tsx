...
const About2 = () => {
  return (
    <section className="pt-20 lg:pt-40 pb-20  min-h-screen w-full bg-black">
      <Wrapper>
        <div className="flex flex-col lg:flex ">
          ...
          <div className="flex flex-col lg:flex  w-full  lg:w-2/5  gap-4 items-center justify-center ">
